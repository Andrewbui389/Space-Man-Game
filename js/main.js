...
let gameStatus; // null -> game in progress; 'W' -> won; 'L' -> loss
...
const guessEl = document.querySelector('#guessE')
...
function renderMessage(){
    if (gameStatus === 'W'){
        msgEl.textContent = 'Chicken Dinner!'
...
function handleLetterClick(evt){
    const ltr = evt.target.textContent.toUpperCase();
    //guards
    if (
        gameStatus || 
